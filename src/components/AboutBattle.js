   ...
   <section className="plain" >
    <div style={{ textAlign: 'center' }}>
      <Parallax bgImage={ image1 } strength={500}>
        ...
        <div style={inlineStyle}>Why is Battle Rap the $#@!</div>
        </div>
      </Parallax> 
      <div class="row">
      <div class="card col s4" style={{height: "400px", marginLeft: "20px"}}>
      <div class="card-image waves-effect waves-block waves-light">
        <img style={{paddingTop: "20px"}}className="activator" src="https://cdn.buttercms.com/jdOleijRuq2hw1fsuWgz"/>
      </div>
      <div className ="card-content" style={{background: "white"}}>
        <span class="card-title activator grey-text text-darken-4">What is Battle Rap?<i class="material-icons right">more_vert</i></span>
      ...
      <div class="card-reveal">
        ...
        <p>So, how did rap battling get this way? How did it turn into a kind of consciously staged reality show, where almost every lyric is pre-written, there’s no beat to speak of and everything is caught on camera? Where you can throw an insult at somebody that, anywhere else on earth, would get you a pounding, but somehow here ends in high-fives and hugs?
      ...
      <div className="col s6" style={{marginLeft: "60px",marginTop: "100px"}}><p>Modern rap battling works like this. There are no beats and no mics. Almost every rhyme will have been prewritten days or weeks in advance, with opponents studied and dissected for weaknesses. Anything goes; literally everything is fair game. Family members, race, physical defects, sexual preferences – as long as it’s rhymed, it’s all good. Obvious and clumsy are bad. Witty and cunning are good. Rhythm is not important, but theatricality, comedic timing and personality are. Make the crowd laugh, and you’ll walk away from the battle a winner.</p></div>
    </div>
      ...
      <Parallax bgImage={ image3 } strength={-200} >
        <div style={{ height: 500 }}>
          ...
          8 Miles(The Movie) Success</div>
        </div>
      </Parallax>
       <div class="row">
      <div class="card col s4" style={{height: "400px", marginLeft: "20px"}}>
      <div class="card-image waves-effect waves-block waves-light">
        <img style={{paddingTop: "20px"}}className="activator" src="https://www.nme.com/wp-content/uploads/2018/11/eminem-8-mile-rexfeatures_1555158a.jpg"/>
      </div>
      <div className ="card-content">
        <span class="card-title activator grey-text text-darken-4">What is Battle Rap?<i class="material-icons right">more_vert</i></span>
...
// Some of the most heralded battle rappers today are Iron Solomon, Math Hoffa, Truth, Envy, Dert Mobz, Aye-verb, Hitman Holla,  Yung Ill, DNA, Cortez, X-factor, Tsunami Surf, Tech N9ne, Goodz, MC Larry, Shotgun Suge, Calicoe, Big T, Tiger Ty, K-shine, T-Rex,, Tay Rock, Illmaculate, Dumbfounded, Dirtbag Dan, Kid Twist, Dizaster, Organik (Host of King of the Dot), Charron, The Saurus, Loaded Lux, Murda Mook, Soul Khan, Swave Sevah, Johnny Storm, Ness  Rone Pat Stay, Conceited,  and Jin..
...
// import crowd1 from './img/crowd1.jpg'
// import  "./AboutBattle.css"
...
//           <img src="https://images.unsplash.com/photo-1501386761578-eac5c94b800a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2700&q=80" alt="image of crowd"/> 
//        </div>
...
//         <img src="https://cdn.buttercms.com/jdOleijRuq2hw1fsuWgz" alt="image of crowd"/> 
//         </div>
//         <div className="section white">
//           <h2>afaffdfdfsgsg</h2>
//           <p>fsfsfsfsf</p>
